        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm mb-4 text-gray-400 leading-relaxed">
              Build your travel experience with BOOKIT. Professional platform with live preview, user-friendly interface, and instant booking.
            </p>
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-2">
              <FaEnvelope className="text-blue-400" />
              support@bookit.gammerce.in
            </div>
